 ...
 * Date: May 2013
 * Dependencies: jQuery 1.9.1 or Zepto 1.0
 * Based on concepts from https://github.com/filamentgroup/RWD-Table-Patterns
 */
        ...
        $hdrCols.each(function(i) {
            ...
            if ($dropdown && !$th.is('.rt-persist') ) {
                var $toggle = $('<li><label for="' + tableId + '-toggle-col-' + i + '">' +
                                '<input type="checkbox" name="toggle-cols" id="' +
                                 tableId + '-toggle-col-' + i + '" value="' + id + '">' +
                                ' ' + $th.text() + '</label></li>');
    ...
    $.fn[pluginName] = function ( options ) {
        return this.each(function () {
            if (!$.data(this, 'plugin_' + pluginName)) {
                ...
                new ResponsiveTable( this, options ));
            }
        });
    };
